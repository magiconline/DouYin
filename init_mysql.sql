...
-- 插入用户
INSERT INTO `user` (`user_id`, `user_name`, `password`, `follow_count`, `follower_count`) VALUES (1, 'test_user', '12345678', 0, 0);
-- 插入点赞状态表
...
SELECT * FROM `remark` WHERE video_id = 3 ORDER BY create_time desc